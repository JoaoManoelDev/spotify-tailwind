...
export function Footer() {
  return (
    <footer className='bg-zinc-800/40 border-t border-zinc-700 p-6 flex items-center justify-between'>
        <div className='flex items-center gap-3'>
          ...
          <div className='flex flex-col'>
            <strong className='font-normal'>Isaías 53</strong>
            <span className='text-xs text-zinc-400'>Projeto Sola</span>
          </div>
        </div>
